...
Can you share the details? Looking forward to connecting! 😊`);
  ...
  const openWhatsApp = () => {
    ...
    window.open(isMobile ? url : `https://web.whatsapp.com/send?phone=${phoneNumber}&text=${message}`, "_blank");
  };
  ...
  return (
    <nav className="bg-gray-800 text-white p-3 fixed w-full top-0 z-50 shadow-lg">
      <div className="container mx-auto flex justify-between items-center px-4 md:px-6">
        <div className="flex items-center space-x-2 cursor-pointer" onClick={() => navigate('/training-institute')}> 
          <img
        ...
        <div className="hidden lg:flex space-x-6 text-sm">
          <div className="flex items-center space-x-2">
            <FaPhone /><span>+91 789654123</span>
          </div>
          <div className="flex items-center space-x-2">
            <FaPhone /><span>205056393 (UAE)</span>
          </div>
